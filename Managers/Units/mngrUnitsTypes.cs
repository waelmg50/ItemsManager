...
namespace Managers
{
    public partial class mngrUnitsTypes : BaseManager
    {

        #region Select Functions

        public static DataTable GetUnitsTypes()
        {
            return SqlAdoWrapper.ExecuteQueryCommand("UnitsTypes_Select", null, false);
        }
        ...
        public static int Insert(entUnitsTypes entSave)
        {
            try
            {
		...
		sqlprmComParam[1] = new SqlParameter("@Name", entSave.Name);
                ...
                int iRes = SqlAdoWrapper.ExecuteNonQueryCommand("UnitsTypes_Insert", sqlprmComParam,false);
        ...
        public static int Update(entUnitsTypes entSave)
        {
            try
            {
		...
		sqlprmComParam[1] = new SqlParameter("@Name", entSave.Name);
                ...
                sqlprmComParam[2] = UserID;
                int iRes = SqlAdoWrapper.ExecuteNonQueryCommand("UnitsTypes_Update", sqlprmComParam, false);
                if (iRes > 0)
                    return iRes;
                return -1;
            }
        ...
        public static int Delete(int iID)
        {
            try
            {
                ...
                return SqlAdoWrapper.ExecuteNonQueryCommand("UnitsTypes_Delete",
