...
namespace Managers
{
    public partial class mngrUnits : BaseManager
    {
        ...
        {
            return SqlAdoWrapper.ExecuteQueryCommand("Units_Select", null, false);
        }
        ...
        public static int Insert(entUnits entSave)
        {
            try
            {
		...
		sqlprmComParam[2] = new SqlParameter("@TypeID", entSave.TypeID);

                sqlprmComParam[3] = UserID;
                int iRes = SqlAdoWrapper.ExecuteNonQueryCommand("Units_Insert", sqlprmComParam,false);
        ...
        public static int Update(entUnits entSave)
        {
            try
            {
		...
		sqlprmComParam[2] = new SqlParameter("@TypeID", entSave.TypeID);
                ...
                sqlprmComParam[3] = UserID;
                int iRes = SqlAdoWrapper.ExecuteNonQueryCommand("Units_Update", sqlprmComParam, false);
                if (iRes > 0)
                    return iRes;
                return -1;
            }
        ...
        public static int Delete(int iID)
        {
            try
            {
                ...
                return SqlAdoWrapper.ExecuteNonQueryCommand("Units_Delete",
