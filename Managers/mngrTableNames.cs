...
namespace Managers
{
    public partial class mngrTableNames : BaseManager
    {
        ...
        public static string GetDisplayNameByDBName(string strDBName)
        {
            try
            {
                ...
                object objRes = SqlAdoWrapper.ExecuteScalarCommand("TablesNames_SelectByDBName", sqlprmSelectParameters, false);
