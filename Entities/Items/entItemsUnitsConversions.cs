...
namespace Entities
{
    public class entItemsUnitsConversions : BaseEntity
    {
...
_Quantity= 0;
        ...
        /// </summary>
        public entItemsUnitsConversions()
        {
            SetDefaults();
        }
        /// <summary>
        ...
        public entItemsUnitsConversions(int iID)
            : base(iID)
        {
            try
            {
                ...
                DataTable tblRow = SqlAdoWrapper.ExecuteQueryCommand("ItemsUnitsConversions_SelectByID", param,
                    false);
...
_Quantity= rowCurr["Quantity"] == DBNull.Value ?0: Convert.ToDecimal(rowCurr["Quantity"]);
        ...
        public static bool operator ==(entItemsUnitsConversions lhs, entItemsUnitsConversions rhs)
        {
            if (
                lhs.ID == rhs.ID
