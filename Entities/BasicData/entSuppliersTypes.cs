...
namespace Entities
{
    public class entSuppliersTypes : BaseEntity
    {
        ...
        public entSuppliersTypes(int iID)
            : base(iID)
        {
            try
            {
                ...
                DataTable tblRow = SqlAdoWrapper.ExecuteQueryCommand("SuppliersTypes_SelectByID", param,
                    false);
        ...
        public static bool operator ==(entSuppliersTypes lhs, entSuppliersTypes rhs)
        {
            if (
                lhs.ID == rhs.ID
&& lhs._Name == rhs._Name
